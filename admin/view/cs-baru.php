...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      <form class="form-horizontal" action="cs-baru.php" method="post" enctype="multipart/form-data">
      <input type="hidden" name="mode" value="csbaru">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8 col-xs-12">
                <div class="input-group"> <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                  <input type="text" class="form-control" name="namacs">
                </div>
