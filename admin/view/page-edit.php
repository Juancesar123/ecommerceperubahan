...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      <form class="form-horizontal" method="post" enctype="multipart/form-data" name="pageedit" action="page-edit.php">
        <input type="hidden" name="mode" value="pageedit">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8 col-xs-12">
                <input type="text" class="tagsinput" name="katakunci" value="<?PHP echo"$key"; ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12 col-xs-12">
                <textarea class="summernote" name="isipage"><?PHP echo"$isipage"; ?></textarea>
