	...
	?>
        <div class="col-md-3 col-sm-6 col-xs-12 isotope-item">
          <div class="productBox">
            <div class="productImage hoverStyle"> <a href="<?PHP echo($defaulturl.$data['seo']) ?>"><img alt="<?PHP echo($data['namaproduk'])?>" src="<?PHP echo($defaulturl) ?>/assets/produk/<?PHP echo($data['thumb1']) ?>"></a>
              <div class="hoverBox">
                <div class="hoverIcons"> <a href="<?PHP echo($defaulturl.$data['seo']) ?>" class="eye hovicon" title="Detail Produk"><i class="fa fa-folder-open" title="detail produk"></i></a> </div>
            ...
            <div class="productDesc"> <span class="product-title"><a href="<?php echo $defaulturl; ?><?PHP echo($data['seo']) ?>"><?PHP echo($data['namaproduk']) ?></a></span>
              ...
              <?PHP }else{ ?>
              <strong class="productPrice">Rp. <?PHP echo number_format($data['harga']) ?></strong> <strong class="big-sel-price">-</strong>
              <?PHP } ?>
            </div>
          </div>
        </div>
...
if($halaman < $jmlhalaman){
	$next=$halaman+1;
					?>
          <a href="<?PHP echo($defaulturl.all."/".$next."/produk.html") ?>" class="nextPage"> <i class="fa fa-angle-right"></i></a>
          <?php }else{ ?>
